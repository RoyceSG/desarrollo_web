...
function rCelular1() {
	document.getElementById("resultado").innerHTML = Celular1.InfoCelular();
}

function rCelular2() {
	document.getElementById("resultado").innerHTML = Celular2.InfoCelular();
}

function rCelular3() {
	document.getElementById("resultado").innerHTML = Celular3.InfoCelular();
}
